...
import { PropsType } from "@/app/(viewPage)/_Components/ProEdit";
...
export const AccountProfile = ({ name, social, image, about }: PropsType) => {
  ...
  return (
    <div className="bg-white border shadow-sm rounded-2xl px-2 py-4 w-[450px] ">
      {/* Upload */}
        ...
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-2">
          ...
          <div className="flex justify-between gap-10">
            <button
              type="submit"
              disabled={loading}
              className={`w-full bg-gray-500 text-white p-2 rounded mt-6 ${
